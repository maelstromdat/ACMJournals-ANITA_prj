...
\begin{figure}[h!]
	\subfigure[Surface Web. \label{fig:distributionSURFACE}]{\includegraphics[width=.47\textwidth]{./img/surfaceWEB.pdf}}
	\hfill
	\subfigure[Deep-, Dark-Web. \label{fig:distributionDEEPDARK}]{\includegraphics[width=.47\textwidth]{./img/deepDARKweb.pdf}}
